...
################################################################################
    ...
    parser.add_argument("-m", "--model_to_use", type=int, help="specify model to use", default=3, choices={3, 4})
    #parser.add_argument('video1', metavar='video1', type=str, help='specify video file')
